      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-purple-700">Now in Beta</span>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-sm sm:text-lg shadow-xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 flex items-center space-x-2 group"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white/80 backdrop-blur-sm border-2 border-gray-200 hover:border-purple-300 text-gray-700 hover:text-purple-700 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-sm sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
              See how it works
            </motion.button>
          </motion.div>
          ...
          <motion.div 
            variants={itemVariants}
            className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 mb-16 sm:mb-20"
          >
            {[
