...
const EmailVerification = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-100/50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Success Animation */}
        {showSuccess && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-10 backdrop-blur-sm text-center mb-8">
            ...
            <div className="flex items-center justify-center">
              ...
              <span className="text-slate-600">Redirecting to onboarding...</span>
            </div>
          </div>
        )}
        ...
        {/* Verification Form */}
        {!showSuccess && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-10 backdrop-blur-sm">
            {error && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border border-slate-300 rounded-xl text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-white text-center text-2xl font-mono tracking-widest"
                    placeholder="000000"
                    maxLength="6"
                    autoFocus
                  />
            ...
            <div className="mt-8 text-center">
              ...
              <button
                ...
                className="text-purple-600 hover:text-purple-700 font-semibold transition-colors hover:underline disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isResending ? (
                  <div className="flex items-center justify-center">
              ...
              {resendMessage && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm animate-fade-in">
